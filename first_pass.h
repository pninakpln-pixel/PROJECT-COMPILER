/*
 * First Pass:
 * Performs the first pass on the assembly source file after macro expansion. 
 * It builds the symbol table, encodes data and instructions into memory 
 * buffers, and tracks address counters (IC and DC).
 */
